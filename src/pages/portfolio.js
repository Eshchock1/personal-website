...
{this.state.workContent}
    ...
    <div className={this.state.workClassList} style={{textAlign:'left'}}>
        <h1 id="work0" onClick={()=>this.handleWorkClick(0)}>BitSwap</h1>
        <h1 id="work1" onClick={()=>this.handleWorkClick(1)}>SnapSmile</h1>
        <h1 id="work2" onClick={()=>this.handleWorkClick(2)}>Quento</h1>
        <h1 id="work3" onClick={()=>this.handleWorkClick(3)}><span className="noFont">2381</span> Robotics</h1>
