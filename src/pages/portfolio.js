...
constructor(props) {
  super(props);
  this.state = {activeWork:0, rotation:360, mobileWorkMenuClassList:"mobileWorkMenu", workClassList:'works', workContent:<div><div><h2>Revolutionizing design to code</h2><p>Led front end development for BitSwap, the world's first BitClout exchange valued at $10M. Collaborated with designers and backend developers, to build, test, and deploy BitSwap's centralized and decentralized exchange web applications. Designed and developed dynamic applications using Figma and React to provide users with the best experience to buy and sell BitClout with ease.</p><a href="https://www.useunify.app/">Launch Project &nbsp;<FaArrowRight/></a><div className="stats"><div><h4>ROLE</h4><h6>Creator</h6></div><div><h4>SKILLS</h4><h6>ReactJS<br/>Figma<br/>ExpressJS<br/>Firebase</h6></div><div><h4>YEAR</h4><h6>2022</h6></div></div></div></div>};
}
